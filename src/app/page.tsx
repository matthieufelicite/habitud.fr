						...
						<div className="mx-auto max-w-7xl px-6 lg:px-8">
							...
							<div className="mx-auto max-w-2xl text-center">
								...
								<p className="mt-6 text-lg leading-8 text-gray-600">
									...
									<span className='text-gradient'>habitud</span> vous permet de changer votre vie grace au pouvoir des habitudes. Construisez de bonnes habitudes et supprimez les mauvaises en quelques secondes par jour.
								</p>
